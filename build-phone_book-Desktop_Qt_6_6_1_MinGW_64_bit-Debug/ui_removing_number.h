/********************************************************************************
** Form generated from reading UI file 'removing_number.ui'
**
...
#ifndef UI_REMOVING_NUMBER_H
#define UI_REMOVING_NUMBER_H
...
public:
    ...
    void setupUi(QDialog *removing_number)
    {
        if (removing_number->objectName().isEmpty())
            removing_number->setObjectName("removing_number");
        removing_number->resize(521, 411);
        layoutWidget = new QWidget(removing_number);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(160, 130, 203, 197));
...
""));
        ...
        verticalLayout_3->addWidget(pushButton_remove_number);


        retranslateUi(removing_number);

        QMetaObject::connectSlotsByName(removing_number);
    } // setupUi

    void retranslateUi(QDialog *removing_number)
    {
        removing_number->setWindowTitle(QCoreApplication::translate("removing_number", "Dialog", nullptr));
        label->setText(QCoreApplication::translate("removing_number", "name", nullptr));
        label_2->setText(QCoreApplication::translate("removing_number", "type", nullptr));
        label_3->setText(QCoreApplication::translate("removing_number", "number", nullptr));
        pushButton_remove_number->setText(QCoreApplication::translate("removing_number", "remove number", nullptr));
    } // retranslateUi

};

namespace Ui {
    class removing_number: public Ui_removing_number {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_REMOVING_NUMBER_H
