/********************************************************************************
** Form generated from reading UI file 'adding_number.ui'
**
...
#ifndef UI_ADDING_NUMBER_H
#define UI_ADDING_NUMBER_H
...
public:
    ...
    QPushButton *pushButton_add_number;

    void setupUi(QDialog *adding_number)
    {
        if (adding_number->objectName().isEmpty())
            adding_number->setObjectName("adding_number");
        adding_number->resize(495, 372);
        layoutWidget = new QWidget(adding_number);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(100, 80, 251, 197));
...
""));
        ...
        pushButton_add_number = new QPushButton(layoutWidget);
        pushButton_add_number->setObjectName("pushButton_add_number");
        pushButton_add_number->setStyleSheet(QString::fromUtf8("QPushButton {\n"
...
""));
        ...
        verticalLayout_3->addWidget(pushButton_add_number);


        retranslateUi(adding_number);

        QMetaObject::connectSlotsByName(adding_number);
    } // setupUi

    void retranslateUi(QDialog *adding_number)
    {
        adding_number->setWindowTitle(QCoreApplication::translate("adding_number", "Dialog", nullptr));
        label->setText(QCoreApplication::translate("adding_number", "name", nullptr));
        label_2->setText(QCoreApplication::translate("adding_number", "type", nullptr));
        label_3->setText(QCoreApplication::translate("adding_number", "number", nullptr));
        pushButton_add_number->setText(QCoreApplication::translate("adding_number", "add number", nullptr));
    } // retranslateUi

};

namespace Ui {
    class adding_number: public Ui_adding_number {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADDING_NUMBER_H
